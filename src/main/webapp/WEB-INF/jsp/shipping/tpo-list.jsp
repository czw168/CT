...
<body>
	...
	<div id="tpoDetailsWindow" class="easyui-window" title="TPO Details" data-options="closed:true,iconCls:'icon-save',href:'${pageContext.request.contextPath }/shipping/tpo-details',maximized:true" ></div>
	...
	<div id="toolbar">
        <a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="newTPO()">New</a>
        <a href="#" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="editTPO()">Edit</a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<script type="text/javascript"> 
		...
		function newTPO(){
			$("#tpoNewWindow").window({
				onLoad :function(){
					/* $.get("getMaxTpo",function(result) {
						$('#new_tpo').textbox('textbox').css('background','#ccc');
						$('#new_tpo').textbox('setValue',result.data);
					}); */
					$('#new_tpo').textbox('setValue','new');
					$('#new_tpo').textbox('textbox').css('background','#ccc');
				}
        	}).window("open");
		}
		...
		function editTPO(){
			...
			$("#tpoEditWindow").window({
				onLoad :function(){
					var data = $("#tpoList").datagrid("getSelections")[0];
					$("#tpo1EditFrom").form("load",data);
					$('#tpo1Edit_tpo').textbox('textbox').css('background','#ccc');
