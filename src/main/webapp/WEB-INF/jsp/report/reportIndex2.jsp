   		...
   		<div style="margin-top: 10px;margin-left: 10px;">
	   		<form id="dataForm" method="post" onsubmit="return false;">
	   			<table>
	    			<tr><td>&nbsp;</td></tr>
	    			<tr><td>Lot No.:</td></tr>
	    			<tr><td><input class="easyui-textbox" name="lotNo" id="lotNo" style="width: 150px" data-options="validType:'length[14,14]',required:true,prompt:'xxxxxxxxxx-xxx'"/></td></tr>
	    			<tr><td>&nbsp;</td></tr>
	    			<tr><td>
...
<script type="text/javascript">
	...
	function datasubmit(){
		...
		if(!$('#dataForm').form('validate')){
			$.messager.alert('massage','Please fill in the form!');
			return;
		}
		var url = "${pageContext.request.contextPath}/report/report-list2?lotNo="+lotNo;
		var title = "Lot Dimension";
		addTab(title,url);
	}
