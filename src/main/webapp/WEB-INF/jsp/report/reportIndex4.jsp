...
<body class="easyui-layout" onkeydown="keyLogin();">
	<div data-options="region:'north',border:false" style="height:45px;padding:10px;">Carrier Tape System&nbsp;&nbsp;&nbsp;Current User ：[${subject.principal}]&nbsp;&nbsp;<input type="button" id="setting" value="Report parameter setting"/></div>
   		...
   		<div style="margin-top: 10px;margin-left: 10px;">
	   		<form id="dataForm" method="post" onsubmit="return false;">
	   			<table>
	    			...
	    			<tr><td>&nbsp;</td></tr>
	    			<tr><td>
	    				<a href="javascript:;" class="easyui-linkbutton" onclick="javascript:location.href='${pageContext.request.contextPath}/reportMenu'">Return to report menu</a>
	    			</td></tr>
    			</table>
	   		</form>
   		</div>
...
<script type="text/javascript">
	...
	function datasubmit(){
        ...
        $.get("${pageContext.request.contextPath}/report/getReportSetting?productNumber="+productNo,function(result){
        	...
        	if(table == null){
		  	...
		  	var url = "${pageContext.request.contextPath}/report/report-list4?date="+date+"&table="+table;
	...
	$("#setting").click(function(){
		//var admin = "${user.a501admin}";
		//if(admin == "true"){
			location.href = "${pageContext.request.contextPath}/report/report-setting";
		//}else{
		//	$.messager.alert('提示',"该用户无访问权限!");
		//}
	});
