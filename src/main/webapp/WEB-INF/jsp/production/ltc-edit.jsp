	...
	<form id="ltcEditFrom">
		...
		<table>
			...
			<tr>
				<td>Customer : </td>
				<td>
					<input class="easyui-textbox" name="customerName" id="new_customerName" style="width: 180px" data-options="required:true,readonly:true" >
				</td>
				<td>Lot Serics : </td>
...
$.extend($.fn.validatebox.defaults.rules, {
	...
	/* function submitForm(){
	    var validate = $("#ltcEditFrom").form('validate');
	    if (!validate) {
			$("#ltcEditFrom").find(".validatebox-invalid:first").focus();
	        return false;
	    }
	    ...
	    $.ajax({
	        url: 'newLTC',
	        type: "Post",
	        data: JSON.stringify($("#ltcEditFrom").serializeJSON()),
	        contentType: "application/json;charset=UTF-8",
	        success: function (result) {
