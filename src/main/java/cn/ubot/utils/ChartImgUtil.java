...
//		StandardPieSectionLabelGenerator sp1 = new StandardPieSectionLabelGenerator("{0}  {2}", nf, df);// 获得StandardPieSectionLabelGenerator对象
	...
	private static DefaultCategoryDataset getLineDataset(List<Map<String, Object>> dateList) {
		...
		for (Map<String, Object> map : dateList) {
			dataset.setValue(Integer.parseInt(map.get("count").toString()), "", map.get("name").toString());
		}
         return dataset;
    }
	...
	private static CategoryDataset getBarDataSet(List<Map<String, Object>> dateList) {
		DefaultCategoryDataset dataset = new DefaultCategoryDataset();
		for (Map<String, Object> map : dateList) {
			dataset.addValue(Integer.parseInt(map.get("count").toString()), map.get("name").toString(), map.get("name").toString());
		}
		return dataset;
	}
	...
	public static void main(String[] args) {
		...
		try {
			writeLineImg(dateList , "title", "xName", "yName", "C:\\Users\\victor_chen\\Desktop\\zxt.png");
		} catch (Exception e) {
